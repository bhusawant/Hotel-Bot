...
class Feedback:
    ...
    def __init__(self, master):
        ...
        master.title('Explore the Feedback')
        ...
        ttk.Label(self.frame_header,wraplength = 300,  text = ("We are glad you chose Hotel Pisces for your recent adventure."
                                             "Please tell us what you thought about the services provided by 'Hotel Bot")).grid(row = 1, column = 1)
